...
static const char *HUE_URL_ROOT = "127.0.0.1:8000/api/newdeveloper/";
static const char *HUE_URL_GROUP = "127.0.0.1:8000/api/newdeveloper/lights/1/state";
...
static void send_command(char *string_body, char *url) {
	cJSON *body = cJSON_Parse(string_body);
